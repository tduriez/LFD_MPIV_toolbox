...
% Last Modified by GUIDE v2.5 10-Feb-2017 17:15:50
...
appdata.GUIDEOptions = struct(...
    ...
    'syscolorfig', [], ...
    'blocking', 0, ...
    'lastSavedFile', '/home/thomas/Dropbox/microflux-GPC/PIV/LFD_MPIV_quick_PIV/private/Inter_export.m', ...
    'lastFilename', '/home/thomas/Dropbox/microflux-GPC/PIV/LFD_MPIV_quick_PIV/LFD_MPIV_Interface/Inter_export.fig');
...
'PaperUnits','inches',...
'Units','characters',...
'Position',[135.714285714286 62.625 109 14.3125],...
...
appdata = [];
appdata.lastValidTag = 'pop_exten';

h3 = uicontrol(...
'Parent',h1,...
'FontUnits',get(0,'defaultuicontrolFontUnits'),...
'Units','characters',...
'String',{  '.mat (MATLAB structure) '; '.csv (formatted text)'; '.dat (TECPLOT)' },...
'Style','popupmenu',...
'Value',[],...
'ValueMode',get(0,'defaultuicontrolValueMode'),...
'Position',[4.71428571428571 8.5 30.8571428571429 1.75],...
'Callback',@(hObject,eventdata)Inter_export('pop_exten_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'Enable','off',...
'ParentMode','manual',...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)Inter_export('pop_exten_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'Tag','pop_exten');
...
'String',{  'Static Text' },...
'Style','text',...
'Position',[31.4285714285714 11.1875 75.7142857142857 1.9375],...
'Children',[],...
'ParentMode','manual',...
'Tag','folder_txt',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
...
'Value',[],...
'ValueMode',get(0,'defaultuicontrolValueMode'),...
'Position',[42.7142857142857 8.625 30.8571428571429 1.75],...
'Callback',@(hObject,eventdata)Inter_export('pop_vec_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'KeyPressFcn',blanks(0),...
'ParentMode','manual',...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)Inter_export('pop_vec_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'DeleteFcn',blanks(0),...
'ButtonDownFcn',blanks(0),...
'Tag','pop_vec');

appdata = [];
appdata.lastValidTag = 'edt_vec';
...
'String',{  'Edit Text' },...
'Style','edit',...
'Position',[42.5714285714286 6.3125 28.7142857142857 1.6875],...
'Callback',@(hObject,eventdata)Inter_export('edt_vec_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'KeyPressFcn',blanks(0),...
'ParentMode','manual',...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)Inter_export('edt_vec_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'DeleteFcn',blanks(0),...
'ButtonDownFcn',blanks(0),...
'Tag','edt_vec');
...
'String','File format',...
'Style','text',...
'Position',[4.71428571428571 6.125 28.7142857142857 2.0625],...
'Children',[],...
'ParentMode','manual',...
'Tag','text3',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
