...
% Last Modified by GUIDE v2.5 26-Apr-2017 14:56:06
...
'Position',[7 16.5625 57.2857142857143 14.25],...
...
'CameraViewAngle',6.60861036031192,...
'CameraViewAngleMode',get(0,'defaultaxesCameraViewAngleMode'),...
'Position',[36.7142857142857 1.0625 57.2857142857143 14.25],...
'ActivePositionProperty','position',...
'ActivePositionPropertyMode',get(0,'defaultaxesActivePositionPropertyMode'),...
'LooseInset',[14.5785714285714 3.56125 10.6535714285714 2.428125],...
'LooseInsetMode',get(0,'defaultaxesLooseInsetMode'),...
...
'String','Informations',...
'Style','text',...
'Position',[75.1428571428571 29.1875 26.1428571428571 2.0625],...
'Children',[],...
'ParentMode','manual',...
'Tag','infotext',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
...
'Position',[15.4285714285714 7.3125 14.4285714285714 2.125],...
...
'String','Quick PIV',...
'Style',get(0,'defaultuicontrolStyle'),...
'Position',[15.4285714285714 4.125 14.4285714285714 2.0625],...
