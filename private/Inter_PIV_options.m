...
% Last Modified by GUIDE v2.5 10-Feb-2017 17:16:49
...
appdata.GUIDEOptions = struct(...
    ...
    'syscolorfig', [], ...
    'blocking', 0, ...
    'lastSavedFile', '/home/thomas/Dropbox/microflux-GPC/PIV/LFD_MPIV_quick_PIV/private/Inter_PIV_options.m', ...
    'lastFilename', '/home/thomas/Dropbox/microflux-GPC/PIV/LFD_MPIV_quick_PIV/LFD_MPIV_Interface/Inter_PIV_options.fig');
...
'PaperUnits','inches',...
'Units','characters',...
'Position',[135.714285714286 44.5625 112.142857142857 32.375],...
...
'Style','text',...
'Position',[21.4285714285714 28.0625 24.5714285714286 1.5],...
'Children',[],...
'ParentMode','manual',...
'Tag','text4',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
...
'String','64',...
'Style','edit',...
'Position',[8.85714285714286 21.625 7.28571428571429 2.5],...
...
'Position',[25.1428571428571 10.375 20.2857142857143 17.875],...
...
'Style','text',...
'Position',[3.71428571428571 24.5 17.5714285714286 2.1875],...
'Children',[],...
'ParentMode','manual',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
'Tag','text2');
...
'String','Overlap',...
'Style','text',...
'Position',[3.71428571428571 17.3125 17.5714285714286 2.1875],...
'Children',[],...
'ParentMode','manual',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
'DeleteFcn',blanks(0),...
...
'String','50',...
'Style','edit',...
'Position',[9 15.1875 6.85714285714286 2.6875],...
...
'Style','checkbox',...
'Value',[],...
'Position',[10 7.9375 25.5714285714286 1.4375],...
...
'Position',[48 24.5625 11.8571428571429 2.8125],...
...
'String','Remove',...
'Style',get(0,'defaultuicontrolStyle'),...
'Position',[48.2857142857143 19.875 11.8571428571429 2.8125],...
...
'Style',get(0,'defaultuicontrolStyle'),...
'Position',[89.2857142857143 1 17.8571428571429 3.1875],...
