...
% Last Modified by GUIDE v2.5 26-Apr-2017 16:24:40
...
appdata.GUIDEOptions = struct(...
    ...
    'syscolorfig', 1, ...
    'blocking', 0, ...
    'lastSavedFile', '/home/thomas/00_Git_repos/LFD_MPIV_Toolbox/private/Inter_PIV_options.m', ...
    'lastFilename', '/home/thomas/00_Git_repos/LFD_MPIV_Toolbox/LFD_MPIV_Interface/Inter_PIV_options.fig');
...
'Style','text',...
'Position',[21.4285714285714 28.1875 24.5714285714286 1.5],...
'Children',[],...
'ParentMode','manual',...
'Tag','text4',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
...
'String','64',...
'Style','edit',...
'Position',[8.85714285714286 21.75 7.28571428571429 2.5],...
...
'Position',[25.1428571428571 10.5 20.2857142857143 17.875],...
...
'Style','text',...
'Position',[3.71428571428571 24.625 17.5714285714286 2.1875],...
'Children',[],...
'ParentMode','manual',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
'Tag','text2');
...
'String','Overlap',...
'Style','text',...
'Position',[3.71428571428571 17.4375 17.5714285714286 2.1875],...
'Children',[],...
'ParentMode','manual',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
'DeleteFcn',blanks(0),...
...
'String','50',...
'Style','edit',...
'Position',[9 15.3125 6.85714285714286 2.6875],...
...
'Value',1,...
'ValueMode',get(0,'defaultuicontrolValueMode'),...
'Position',[43.7142857142857 6.5 16 1.75],...
...
'Style','text',...
'Position',[42.7142857142857 8.375 17.5714285714286 2.1875],...
'Children',[],...
'ParentMode','manual',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
'DeleteFcn',blanks(0),...
