...
% Last Modified by GUIDE v2.5 29-Apr-2017 18:28:05
 ...
 uiwait(handles.figure1);
    ...
    function update_list(handles)
        ...
        for i=1:handles.nb_images
            if isempty(intersect(i,handles.output.image_indices))
                state='excl.';
            else
                state='included';
            end
...
h1 = figure(...
'Units','characters',...
'Position',[135.714285714286 25.75 67.8571428571429 31.6875],...
...
'Position',[7 1.5 35.8571428571429 28.6875],...
...
appdata = [];
appdata.lastValidTag = 'index_edt';
...
'String',{  'Edit Text' },...
'Style','edit',...
'Position',[46.7142857142857 17.75 14.4285714285714 2.0625],...
'Callback',@(hObject,eventdata)Inter_image_index('index_edt_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'ParentMode','manual',...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)Inter_image_index('index_edt_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'Tag','index_edt');

appdata = [];
appdata.lastValidTag = 'add_from_bttn';
...
'Position',[46.7142857142857 15.5 13.2857142857143 1.5625],...
'Callback',@(hObject,eventdata)Inter_image_index('add_from_bttn_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'ParentMode','manual',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
'Tag','add_from_bttn');
...
appdata = [];
appdata.lastValidTag = 'remove_from_bttn';

h5 = uicontrol(...
'Parent',h1,...
'FontUnits',get(0,'defaultuicontrolFontUnits'),...
'Units','characters',...
'String','Remove all from',...
'Style',get(0,'defaultuicontrolStyle'),...
'Position',[46.7142857142857 12.875 17.2857142857143 1.5625],...
'Callback',@(hObject,eventdata)Inter_image_index('remove_from_bttn_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
...
'Tag','remove_from_bttn');

appdata = [];
appdata.lastValidTag = 'add_upto_bttn';

h6 = uicontrol(...
'Parent',h1,...
'FontUnits',get(0,'defaultuicontrolFontUnits'),...
'Units','characters',...
'String','Add all up to',...
'Style',get(0,'defaultuicontrolStyle'),...
'Position',[46.7142857142857 22.8125 13.7142857142857 1.5625],...
'Callback',@(hObject,eventdata)Inter_image_index('add_upto_bttn_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'KeyPressFcn',blanks(0),...
'ParentMode','manual',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
...
appdata = [];
appdata.lastValidTag = 'remove_upto_bttn';

h7 = uicontrol(...
'Parent',h1,...
'FontUnits',get(0,'defaultuicontrolFontUnits'),...
'Units','characters',...
'String','Remove all up to',...
'Style',get(0,'defaultuicontrolStyle'),...
'Position',[46.7142857142857 20.625 17.7142857142857 1.5625],...
'Callback',@(hObject,eventdata)Inter_image_index('remove_upto_bttn_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'KeyPressFcn',blanks(0),...
'ParentMode','manual',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
...
'Style',get(0,'defaultuicontrolStyle'),...
'Position',[47.2857142857143 27.4375 14.8571428571429 1.5625],...
...
'Style',get(0,'defaultuicontrolStyle'),...
'Position',[47.2857142857143 29 18.7142857142857 1.5625],...
...
'String','All',...
'Style',get(0,'defaultuicontrolStyle'),...
'Position',[46.7142857142857 7 14.4285714285714 1.75],...
...
appdata = [];
appdata.lastValidTag = 'none_bttn';
...
'String','None',...
'Style',get(0,'defaultuicontrolStyle'),...
'Position',[46.7142857142857 4.75 14.4285714285714 1.75],...
'Callback',@(hObject,eventdata)Inter_image_index('none_bttn_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'KeyPressFcn',blanks(0),...
'ParentMode','manual',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
...
'String','Done',...
'Style',get(0,'defaultuicontrolStyle'),...
'Position',[53.2857142857143 0.875 14.4285714285714 1.75],...
