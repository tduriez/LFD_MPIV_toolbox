...
% Last Modified by GUIDE v2.5 27-Apr-2017 23:52:26
...
handles.im_size=display_image(handles.cxd,handles.output,handles.axes1,4);
...
'String','[1 100 1 100]',...
'Style','edit',...
'Position',[4.28571428571429 26.0625 28.4285714285714 2.3125],...
...
'Style','text',...
'Position',[2.57142857142857 28.4375 31.2857142857143 1.625],...
'Children',[],...
'ParentMode','manual',...
'Tag','text5',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
...
'String',{  'Static Text' },...
'Style','text',...
'Position',[4 21.4375 48.7142857142857 3.5625],...
'Children',[],...
'ParentMode','manual',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
'Tag','service_text');
...
'Position',[8.85714285714286 4.0625 19.5714285714286 3.3125],...
...
'Style','checkbox',...
'Position',[7 17.125 15.7142857142857 1.5],...
...
'Style','checkbox',...
'Position',[7 14.8125 15.7142857142857 1.5],...
...
'Position',[7 11.6875 23.5714285714286 2.0625],...
...
'Style','text',...
'Position',[7 30.1875 23.5714285714286 1.1875],...
'Children',[],...
'ParentMode','manual',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
'DeleteFcn',blanks(0),...
