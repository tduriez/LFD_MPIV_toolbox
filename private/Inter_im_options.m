...
% Last Modified by GUIDE v2.5 13-Feb-2017 18:45:54
...
appdata.GUIDEOptions = struct(...
    ...
    'syscolorfig', 1, ...
    'blocking', 0, ...
    'lastSavedFile', '/home/thomas/Dropbox/shadow_micropiv/LFD_MPIV_quick_PIV/private/Inter_im_options.m', ...
    'lastFilename', '/home/thomas/Dropbox/shadow_micropiv/LFD_MPIV_quick_PIV/LFD_MPIV_Interface/Inter_im_options.fig');
...
'String','Case name',...
'Style','text',...
'Position',[7 34.875 11.2857142857143 1.5625],...
'Children',[],...
'ParentMode','manual',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
'DeleteFcn',blanks(0),...
...
'String','0.038',...
'Style','edit',...
'Position',[42.7142857142857 32 10.7142857142857 2.125],...
...
'String','test',...
'Style','edit',...
'Position',[1.14285714285714 32 23.4285714285714 2.125],...
'Callback',@(hObject,eventdata)Inter_im_options('case_edt_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'KeyPressFcn',blanks(0),...
'ParentMode','manual',...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)Inter_im_options('case_edt_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'DeleteFcn',blanks(0),...
'ButtonDownFcn',blanks(0),...
'Tag','case_edt');
...
'String','Delta t (mus)',...
'Style','text',...
'Position',[28.4285714285714 33.875 11.2857142857143 2.5625],...
'Children',[],...
'ParentMode','manual',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
'DeleteFcn',blanks(0),...
...
'Style','text',...
'Position',[42.7142857142857 34.25 11.2857142857143 2.1875],...
'Children',[],...
'ParentMode','manual',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
'DeleteFcn',blanks(0),...
...
'String','1',...
'Style','edit',...
'Position',[28.4285714285714 32 10.7142857142857 2.125],...
...
appdata = [];
appdata.lastValidTag = 'check_date';
...
'Style','checkbox',...
'Value',1,...
'Position',[2.28571428571429 30.375 11.8571428571429 1.25],...
'Callback',@(hObject,eventdata)Inter_im_options('check_date_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'KeyPressFcn',blanks(0),...
'ParentMode','manual',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
...
'String','[1 100 1 100]',...
'Style','edit',...
'Position',[24.1428571428571 21.25 28.4285714285714 2.3125],...
...
'Style','text',...
'Position',[22.4285714285714 23.625 31.2857142857143 1.625],...
'Children',[],...
'ParentMode','manual',...
'Tag','text5',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
...
'String','test',...
'Style','edit',...
'Position',[1.71428571428571 27.9375 23.4285714285714 2.125],...
'Callback',@(hObject,eventdata)Inter_im_options('the_date_edt_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'KeyPressFcn',blanks(0),...
'ParentMode','manual',...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)Inter_im_options('the_date_edt_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'DeleteFcn',blanks(0),...
'ButtonDownFcn',blanks(0),...
'Tag','the_date_edt');
