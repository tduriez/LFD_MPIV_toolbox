...
% Last Modified by GUIDE v2.5 11-Apr-2017 12:36:30
...
'String','0.038',...
'Style','edit',...
'Position',[18 30.875 10.7142857142857 2.125],...
...
'String','Delta t (mus)',...
'Style','text',...
'Position',[3.71428571428571 32.75 11.2857142857143 2.5625],...
'Children',[],...
'ParentMode','manual',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
'DeleteFcn',blanks(0),...
...
'Style','text',...
'Position',[18 33.125 11.2857142857143 2.1875],...
'Children',[],...
'ParentMode','manual',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
'DeleteFcn',blanks(0),...
...
'String','1',...
'Style','edit',...
'Position',[3.71428571428571 30.875 10.7142857142857 2.125],...
...
'String',{  'Static Text' },...
'Style','text',...
'Position',[3 16.5 48.7142857142857 3.5625],...
'Children',[],...
'ParentMode','manual',...
'Tag','service_text',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
...
'Style','checkbox',...
'Position',[5 13.3125 15.7142857142857 1.5],...
...
'Style','checkbox',...
'Position',[5 11 15.7142857142857 1.5],...
...
'Position',[5 7.875 23.5714285714286 2.0625],...
...
'Style','popupmenu',...
'Value',2,...
'Position',[30.2857142857143 13.375 23 1.4375],...
...
'String','Set Mask',...
'Style',get(0,'defaultuicontrolStyle'),...
'Position',[5.14285714285714 26.6875 17.7142857142857 2.375],...
...
'String','First step',...
'Style','text',...
'Position',[2.85714285714286 35.3125 21.2857142857143 2.3125],...
'Children',[],...
'ParentMode','manual',...
'Tag','message',...
'FontSize',16,...
...
appdata = [];
appdata.lastValidTag = 'no_mask_bttn';
...
'String','No Mask',...
'Style',get(0,'defaultuicontrolStyle'),...
'Position',[26.4285714285714 26.6875 17.7142857142857 2.375],...
'Callback',@(hObject,eventdata)Inter_im_options('no_mask_bttn_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'KeyPressFcn',blanks(0),...
'ParentMode','manual',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
...
appdata = [];
appdata.lastValidTag = 'set_scale_bttn';
...
'String','Set scales',...
'Style',get(0,'defaultuicontrolStyle'),...
'Position',[36.1428571428571 30.75 17.7142857142857 2.375],...
'Callback',@(hObject,eventdata)Inter_im_options('set_scale_bttn_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'KeyPressFcn',blanks(0),...
'ParentMode','manual',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
...
appdata = [];
appdata.lastValidTag = 'set_roi_bttn';
...
'String','Set ROI',...
'Style',get(0,'defaultuicontrolStyle'),...
'Position',[39.2857142857143 21.8125 17.7142857142857 2.375],...
'Callback',@(hObject,eventdata)Inter_im_options('set_roi_bttn_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'KeyPressFcn',blanks(0),...
'ParentMode','manual',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
...
'String','Set transfos',...
'Style',get(0,'defaultuicontrolStyle'),...
'Position',[35 8.5625 17.7142857142857 2.375],...
'Callback',@(hObject,eventdata)Inter_im_options('pushbutton7_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'KeyPressFcn',blanks(0),...
'ParentMode','manual',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
