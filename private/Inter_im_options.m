...
% Last Modified by GUIDE v2.5 02-May-2017 18:13:49
...
'Position',[78.5714285714286 9.125 78.7142857142857 26.1875],...
...
'Color',[0 0 0],...
'ColorMode','auto',...
'Position',[0.500001430511475 1.00656324582339 0.499999999999998],...
'PositionMode','auto',...
'Interpreter','tex',...
...
'Color',[0.15 0.15 0.15],...
'ColorMode','auto',...
'Position',[-0.0550514205217506 0.500000476837158 0],...
'PositionMode','auto',...
'Interpreter','tex',...
'InterpreterMode','auto',...
'Rotation',90,...
...
'Position',[1.42857142857143 11.5625 71.1428571428571 17.5],...
'ParentMode','manual',...
'Tag','uipanel1',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );

appdata = [];
appdata.lastValidTag = 'slider_roi1';
...
'String',{  'Slider' },...
'Style','slider',...
'Position',[2.71428571428571 13.25 45.4285714285714 1.8125],...
'BackgroundColor',[0.9 0.9 0.9],...
'Callback',@(hObject,eventdata)Inter_im_options('slider_roi1_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'ParentMode','manual',...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)Inter_im_options('slider_roi1_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'Tag','slider_roi1');

appdata = [];
appdata.lastValidTag = 'slider_roi2';
...
'String',{  'Slider' },...
'Style','slider',...
'Position',[2.71428571428571 10.25 45.4285714285714 1.8125],...
'BackgroundColor',[0.9 0.9 0.9],...
'Callback',@(hObject,eventdata)Inter_im_options('slider_roi2_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'KeyPressFcn',blanks(0),...
'ParentMode','manual',...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)Inter_im_options('slider_roi2_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'DeleteFcn',blanks(0),...
'ButtonDownFcn',blanks(0),...
'Tag','slider_roi2');

appdata = [];
appdata.lastValidTag = 'slider_roi3';
...
'String',{  'Slider' },...
'Style','slider',...
'Position',[2.71428571428571 7.25 45.4285714285714 1.8125],...
'BackgroundColor',[0.9 0.9 0.9],...
'Callback',@(hObject,eventdata)Inter_im_options('slider_roi3_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'KeyPressFcn',blanks(0),...
'ParentMode','manual',...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)Inter_im_options('slider_roi3_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'DeleteFcn',blanks(0),...
'ButtonDownFcn',blanks(0),...
'Tag','slider_roi3');

appdata = [];
appdata.lastValidTag = 'slider_roi4';
...
'String',{  'Slider' },...
'Style','slider',...
'Position',[2.71428571428571 3.9375 45.4285714285714 1.8125],...
'BackgroundColor',[0.9 0.9 0.9],...
'Callback',@(hObject,eventdata)Inter_im_options('slider_roi4_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'KeyPressFcn',blanks(0),...
'ParentMode','manual',...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)Inter_im_options('slider_roi4_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'DeleteFcn',blanks(0),...
'ButtonDownFcn',blanks(0),...
'Tag','slider_roi4');

appdata = [];
appdata.lastValidTag = 'roi_edt1';
...
'String',{  'Edit Text' },...
'Style','edit',...
'Position',[55.4285714285714 12.6875 7.28571428571428 3],...
'Callback',@(hObject,eventdata)Inter_im_options('roi_edt1_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'ParentMode','manual',...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)Inter_im_options('roi_edt1_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'Tag','roi_edt1');

appdata = [];
appdata.lastValidTag = 'roi_edt2';
...
'String',{  'Edit Text' },...
'Style','edit',...
'Position',[55.4285714285714 9.625 7.28571428571428 3],...
'Callback',@(hObject,eventdata)Inter_im_options('roi_edt2_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'KeyPressFcn',blanks(0),...
'ParentMode','manual',...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)Inter_im_options('roi_edt2_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'DeleteFcn',blanks(0),...
'ButtonDownFcn',blanks(0),...
'Tag','roi_edt2');

appdata = [];
appdata.lastValidTag = 'roi_edt3';
...
'String',{  'Edit Text' },...
'Style','edit',...
'Position',[55.4285714285714 6.625 7.28571428571428 3],...
'Callback',@(hObject,eventdata)Inter_im_options('roi_edt3_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'KeyPressFcn',blanks(0),...
'ParentMode','manual',...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)Inter_im_options('roi_edt3_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'DeleteFcn',blanks(0),...
'ButtonDownFcn',blanks(0),...
'Tag','roi_edt3');

appdata = [];
appdata.lastValidTag = 'roi_edt4';
...
'String',{  'Edit Text' },...
'Style','edit',...
'Position',[55.4285714285714 3.5625 7.28571428571428 3],...
'Callback',@(hObject,eventdata)Inter_im_options('roi_edt4_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'KeyPressFcn',blanks(0),...
'ParentMode','manual',...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)Inter_im_options('roi_edt4_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'DeleteFcn',blanks(0),...
'ButtonDownFcn',blanks(0),...
'Tag','roi_edt4');
...
'String',{  'Edit Text' },...
'Style','edit',...
'Position',[14 1.0625 34.4285714285714 2.25],...
...
'Position',[142.714285714286 0.9375 19.5714285714286 3.3125],...
...
'Style','checkbox',...
'Position',[5.57142857142857 8.8125 15.7142857142857 1.5],...
...
'Style','checkbox',...
'Position',[5.57142857142857 6.5 15.7142857142857 1.5],...
...
'Position',[26.2857142857143 8.25 23.5714285714286 2.0625],...
...
'String','Set Mask',...
'Style',get(0,'defaultuicontrolStyle'),...
'Position',[5.14285714285714 32.9375 17.7142857142857 2.375],...
...
appdata = [];
appdata.lastValidTag = 'clear_mask_bttn';
...
'String','Clear mask',...
'Style',get(0,'defaultuicontrolStyle'),...
'Position',[28.4285714285714 32.9375 17.7142857142857 2.375],...
'Callback',@(hObject,eventdata)Inter_im_options('clear_mask_bttn_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'KeyPressFcn',blanks(0),...
'ParentMode','manual',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
...
'Style','checkbox',...
'Position',[0.43250214961307 0.946428571428572 0.106620808254514 0.0308441558441559],...
'Callback',@(hObject,eventdata)Inter_im_options('showroi_box_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'KeyPressFcn',blanks(0),...
'ParentMode','manual',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
...
'Position',[0.547721410146174 0.946428571428572 0.0868443680137575 0.0340909090909091],...
'Callback',@(hObject,eventdata)Inter_im_options('show_mask_box_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'KeyPressFcn',blanks(0),...
'ParentMode','manual',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
...
'String','Frame A/B',...
'Style',get(0,'defaultuicontrolStyle'),...
'Position',[0.641444539982803 0.944805194805195 0.0644883920894239 0.0340909090909091],...
'Callback',@(hObject,eventdata)Inter_im_options('change_frame_bttn_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'KeyPressFcn',blanks(0),...
'ParentMode','manual',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
...
'String','A',...
'Style','text',...
'Position',[0.708512467755804 0.944805194805195 0.0447119518486673 0.0324675324675324],...
'Children',[],...
'ParentMode','manual',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
'DeleteFcn',blanks(0),...
...
'String',{  'Static Text' },...
'Style','text',...
'Position',[9.57142857142857 3.0625 40.4285714285714 1.75],...
'Children',[],...
'ParentMode','manual',...
'Tag','service_text',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
