...
% Last Modified by GUIDE v2.5 29-Mar-2017 11:31:17
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_LayoutFcn',  @Please_Update_LayoutFcn, ...
                   'gui_Callback',   []);
...
function h1 = Please_Update_LayoutFcn(policy)
...
appdata.GUIDEOptions = struct(...
    ...
    'syscolorfig', 1, ...
    'blocking', 0, ...
    'lastSavedFile', '/home/thomas/00_Git_repos/LFD_MPIV_Toolbox/private/Please_Update.m', ...
    'lastFilename', '/home/thomas/00_Git_repos/LFD_MPIV_Toolbox/LFD_MPIV_Interface/Please_Update.fig');
...
'PaperUnits','inches',...
'Units','characters',...
'Position',[135.714285714286 57 50.2857142857143 19.9375],...
...
'Units','characters',...
'String',{  'Your version of '; 'LFD_MPIV is outdated.'; 'Please update:' },...
'Style','text',...
'Position',[-0.142857142857143 13.625 50 6.125],...
'Children',[],...
'ParentMode','manual',...
'Tag','text2',...
'FontSize',20,...
...
'Position',[14.1428571428571 1.125 22.7142857142857 3.9375],...
'Callback',@(hObject,eventdata)Please_Update('pushbutton1_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'ParentMode','manual',...
'Tag','pushbutton1',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
...
'FontUnits',get(0,'defaultuicontrolFontUnits'),...
'Units','characters',...
'String',{  'Update your git repository'; 'OR'; 'Download the latest zip package.' },...
'Style','text',...
'Position',[0.714285714285714 5.6875 48.2857142857143 6.8125],...
'Children',[],...
'ParentMode','manual',...
'Tag','text3',...
'FontSize',16,...
...
elseif local_isInvokeHGCallback(gui_State, varargin{:})
    % PLEASE_UPDATE('CALLBACK',hObject,eventData,handles,...)
    gui_Create = false;
else
    % PLEASE_UPDATE(...)
