function varargout = Inter_algo_mask(varargin)
% LFD_MPIV_ALGO_MASK MATLAB code for Inter_algo_mask.fig
...
%      applied to the GUI before Inter_algo_mask_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Inter_algo_mask_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Inter_algo_mask

% Last Modified by GUIDE v2.5 28-Apr-2017 14:53:50

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Inter_algo_mask_OpeningFcn, ...
                   'gui_OutputFcn',  @Inter_algo_mask_OutputFcn, ...
                   'gui_LayoutFcn',  @Inter_algo_mask_LayoutFcn, ...
                   'gui_Callback',   []);
...
% --- Executes just before Inter_algo_mask is made visible.
function Inter_algo_mask_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Inter_algo_mask (see VARARGIN)

% Choose default command line output for Inter_algo_mask
...
% UIWAIT makes Inter_algo_mask wait for user response (see UIRESUME)
...
function varargout = Inter_algo_mask_OutputFcn(hObject, eventdata, handles) 
...
function h1 = Inter_algo_mask_LayoutFcn(policy)
...
appdata.GUIDEOptions = struct(...
    ...
    'syscolorfig', 1, ...
    'blocking', 0, ...
    'lastSavedFile', '/home/thomas/Documents/00_gits_reps/LFD_MPIV_toolbox/private/Inter_algo_mask.m', ...
    'lastFilename', '/home/thomas/Documents/00_gits_reps/LFD_MPIV_toolbox/LFD_MPIV_Interface/Inter_algo_mask.fig');
...
h1 = figure(...
'Units','characters',...
'Position',[135.714285714286 17.375 170.428571428571 40.0625],...
'Visible',get(0,'defaultfigureVisible'),...
'Color',get(0,'defaultfigureColor'),...
'CurrentAxesMode','manual',...
'IntegerHandle','off',...
'MenuBar','none',...
'Name','Inter_algo_mask',...
'NumberTitle','off',...
'Resize','off',...
...
'Callback',@(hObject,eventdata)Inter_algo_mask('slider1_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'ParentMode','manual',...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)Inter_algo_mask('slider1_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'Tag','slider1');
...
'Callback',@(hObject,eventdata)Inter_algo_mask('edit1_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'ParentMode','manual',...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)Inter_algo_mask('edit1_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'Tag','edit1');
...
'Callback',@(hObject,eventdata)Inter_algo_mask('pushbutton1_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'ParentMode','manual',...
'Tag','pushbutton1',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
...
'Callback',@(hObject,eventdata)Inter_algo_mask('edit2_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'ParentMode','manual',...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)Inter_algo_mask('edit2_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'Tag','edit2');
